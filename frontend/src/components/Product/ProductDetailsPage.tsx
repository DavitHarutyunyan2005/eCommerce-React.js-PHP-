            ...
            <div className="flex flex-col gap-6 md:w-1/5 justify-center">
                                ...
                                <div className="flex gap-2 mt-2">
                                    {attr.items.map((item: any) => (
                                        <button
                                            ...
                                            className={clsx('border-2 px-4 py-2 cursor-pointer', item.selected ? 'bg-black text-white' : 'bg-white text-black')}
                                        >
                                            {item.value}
                                        </button>
                                    ))}
                ...
                {itemInCart(product) === 0 ?
                    <div className="relative" >
                        ...
                        <div
                            className={
                                'py-2 px-6 font-semibold transition-colors duration-400 ' +
                        ...
                        >
                            ...
                            <span className='text-white'>{itemInCart(product)} ADDED TO CART</span>
                            <button
                                data-testid='add-to-cart'
                                className='border-3 border-white rounded-full p-0.5 cursor-pointer hover:opacity-50'
                                onClick={() => addToCart(product)}
